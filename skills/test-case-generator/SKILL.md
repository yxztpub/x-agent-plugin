...
description: 在代码实施之前必须执行此技能生成测试文档。
---
...
- [ ] 搜索并读取开发任务文档
- [ ] 搜索并读取相关源代码文件
- [ ] 生成测试计划文档 (`<task_name>_test_plan.md`)
- [ ] 生成测试设计文档 (`<task_name>_test_design.md`)
- [ ] 生成测试用例文档 (`<task_name>_test_cases.md`)
- [ ] 确认所有文档已保存到正确位置

**重要：此技能必须产生实际的文档输出，不能只是描述或讨论。**
